...
From the customer portal, you can activate external two-factor authentication (2FA) to add additional protection when logging in to the portal. This additional layer of security protects the account from unverified access, ensuring devices, data, and account information are protected. See [Setting up two-factor authentication](/docs/customer-portal/cpenable2fa.html#customerportal_2fa) for more information.
