...
사용자 이름을 잊어버린 경우 사용자 이름을 검색할 수 있는 계정 관리자 또는 마스터 관리자에게 문의하십시오. 사용자가 계정의 관리자 또는 마스터 관리자인 경우 [지원에 문의](support.html)하십시오. 
...
SoftLayer 계정의 마스터 사용자인 경우 고객 포털에 로그인한 후 헤더에서 **계정 연결**을 클릭하십시오. 자세한 정보는 [IBM ID 사용자 계정 연결](/docs/admin/softlayerlink.html#link_user_accounts)을 참조하십시오. 
...
이중 인증을 사용한 IBM ID의 자세한 정보는 [연결된 계정에서 이중 인증 사용](/docs/admin/softlayerlink.html#2fa)을 참조하십시오.
...
IBM ID로 로그인할 때 *"We didn't recognize this IBMid or email"* 오류가 발생하는 경우 완전한 이메일 주소를 입력했는지 확인하십시오. 또한 {{site.data.keyword.BluSoftlayer_notm}} 인프라 사용자 이름을 사용하지 않았는지 확인하십시오. 
...
## IBM ID로 전환을 완료하기 위한 내 이메일은 어디있습니까?
