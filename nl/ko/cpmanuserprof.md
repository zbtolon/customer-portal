...
포털에 로그인할 때 고객 포털에서 외부 이중 인증을 활성화하여 추가 보호를 수행할 수 있습니다. 이 추가 보안 계층은 확인되지 않은 액세스로부터 계정을 보호하여 디바이스, 데이터 및 계정 정보가 보호되도록 합니다. 이 외부 인증은 다음 형식으로 수행될 수 있습니다. 
...
사용자의 VPN 액세스를 업데이트하면 권한이 적절하게 업데이트되고 VPN 액세스 열에 업데이트된 VPN 액세스 방법이 표시됩니다(해당 경우). 
