...
고객 포털에서 포털에 로그인할 때 추가적인 보호 단계를 추가하기 위해 외부의 이중 인증(2FA)을 활성화할 수 있습니다. 이 추가 보안 계층은 확인되지 않은 액세스로부터 계정을 보호하여 디바이스, 데이터 및 계정 정보가 보호되도록 합니다. 자세한 정보는 [이중 인증 설정](/docs/customer-portal/cpenable2fa.html#customerportal_2fa)을 참조하십시오.
