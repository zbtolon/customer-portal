...
Para obtener más información sobre IBMid con 2FA, consulte [Uso de la autenticación de dos factores en cuentas enlazadas](/docs/account/softlayerlink.html).
